// ITU-T E.164 calling codes for every country/territory, sorted alphabetically
// by country name. Used by the booking form's country selector so a phone
// number always carries an explicit country code instead of being guessed.
